import { Phone, Star, ShieldCheck, Zap, MapPin } from "lucide-react";
import whatsappIcon from "@/assets/whatsapp.png";

import g1 from "@/assets/hero-shop.jpg";
import g5 from "@/assets/g3.png";
import g6 from "@/assets/g5.png";
import g2 from "@/assets/g2.png";
import g3 from "@/assets/h1.png";
      ...
      <div className="relative z-10 mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="max-w-3xl text-white animate-[fade-up_0.8s_ease-out]">
          ...
          <div className="mt-7 flex flex-col sm:flex-row gap-3">
            ...
            <a
              href="https://wa.me/919665405349?text=Hi%20Icon%20Computers%2C%20I%20am%20interested%20in%20your%20products%20or%20services.%20Please%20assist%20me."
              target="_blank"
              rel="noopener"
          ...
          <div className="mt-8 sm:mt-10 grid grid-cols-3 gap-2.5 sm:gap-4 max-w-xl">
            {[
              ...
              >
                ...
                <div className="mt-1.5 text-base sm:text-xl font-extrabold leading-tight">
                  {s.label}
                </div>
